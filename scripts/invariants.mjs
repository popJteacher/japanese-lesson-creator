...
const CANONICAL = {
  ...
  guideManifestExpectedHashPrefix: '8a608d9863c8', // v4.0.7 example_sentence 8 universal subsections (5 refined + 3 new) + Template C v4.0.7 強化 (2026-05-27 / X-c-6 / Gemini 第三/四意見統合) — PART 3.9 を 5→8 subsection に拡張 (3.9.1 aspect_ratio_enforcement edge-bleed 強化 / 3.9.2 scene_action_focus object-manipulation + identity-only 5a/5b 例外 / 3.9.3 affiliation_indoor "INSIDE the [INSTITUTION]" 強化 / 3.9.4 visual_symbol_restriction Diegetic Confusion → 2D UI overlay / 3.9.5 reference_redundancy_avoidance EXCLUSIVELY / 3.9.6 particle_visual_mapping は・が・に・で・を・の・へ table 新設 / 3.9.7 horror_vacui_blank_surfaces 8 surface 表 + positive enumeration / 3.9.8 two_panel_qa_pattern verbatim block) + Template C v4.0.7 に §3.9.7 horror vacui 行追記 + skill md v4.0.7 仕様追加。前 hash: c821d13e646e (v4.0.6 5 subsections) / 15bd5fbf566b (X-c v1 / v4.0.5 PERSON_REFERENCE_ATTACHMENT_RULE) / 0673ca2d537e (v5.0 + v4.0.4 building)
  // S列プロンプト JSON の置き場
