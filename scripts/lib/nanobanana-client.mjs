...
//   - v4.0.4 R11 (2026-05-24): referenceImages による multi-image input 対応
//     ({ bytes: Buffer, mimeType: string }[]) を text prompt 前に inlineData
//     part として並べる。in-context style transfer 用途（擬似 LoRA）。
//     input image は 1024x1024 換算 ~1290 tokens/枚、$0.30/M 課金で
//     1 枚あたり ~$0.0004 上乗せ。Phase 6 で自作 LoRA 切替予定。
//
