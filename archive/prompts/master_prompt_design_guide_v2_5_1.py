...
# Version 2.5.1 | 2026-05-18 (hex値フォーマット修正 / v2.5ベース回帰)
...
##   色名 + hex value の Double-Hex Anchoring 精度は維持。
##   ガイド設計方針: v2.5 に戻す（v2.6〜v2.9 の拡張は不採用）。
##   理由: v2.9 実生成テスト（2026-05-18）で色品質・アスペクト比・複数人物生成の
##         問題を確認。lesson_01/02 は テンプレートA・B・D のみで対応可能。: NAMED_CHARACTER_PROFILES 新設（lesson_01 確定キャラクター5名）。
