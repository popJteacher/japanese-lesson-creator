...
# Version 3.0 | 2026-05-19 (= v2.5回帰ベース / Building-English-Label 確定版)
...
STYLE_BIBLE = {
  ...
  "color_palette": {
    ...
    "note": "v3.0: 色名のみ運用（問題F解決）。#HEX や 'hex value' をプロンプトに書かないこと。色名表記の一字一句を変えないことでスタイルドリフトを防止する（資料6）。"
  },
...
- Background: soft cream white #FBFBFB ()
- Outline: deep slate navy #1B2C40 ()
- Main color: muted warm blue #4A7FB5 ()
- Accent: warm amber gold #FAD141 ()
- Sub color: cool slate gray #6B7C85 ()
