...
// ============================================================================
// SECTION 6: 第2課の語彙（lesson_02.json v2.11.10 SSOT・18語）
// ============================================================================
...
const RubyDict = {
  ...
  _meta: {
    ...
    changes: [
      ...
      'v1.3 (2026-05-18): SECTION 6 ヘッダー参照バージョンを v2.11.7・17語 → v2.11.10・18語 に修正（語彙データ自体は v1.2 時点で既に正しく収録済み・ヘッダー記述のみ更新）。',
    ],
  },
};
