...
Background: minimal — large flat SOLID color fields only. NO gradients, NO 'gradient-free tone' shading, NO lighting effects (must remain completely flat solid fills, consistent with the STYLE RECIPE).
