...
## ※ v2.2 から変更なし（辞書本体）。
##
## v3.9 note: prop contrast rule の適用範囲について
##   build_prompts.py の compose_role_subject に palette-aware prop
##   contrast rule（手に持つ prop は服装支配色と異なる hue family AND/OR
##   value を STYLE_BIBLE.color_palette から選ぶ）が組み込まれている。
