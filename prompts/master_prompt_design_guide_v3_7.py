...
NATIONALITY_NOUN_POLICY = {
  ...
  "principle":
    "The PERSON is the subject, not the flag. A generic adult of plain, "
    ...
    "conveyed ONLY by a small national-flag pin or cloth patch.",
  ...
  "hard_constraints": [
    ...
    # v3.7: caricature/tourist-cliché は禁止のまま、contemporary cultural styling は許容。
    "DO NOT use caricatured features, exaggerated 'national costume' "
    "(such as kimono on every Japanese person, sombrero on every Mexican, "
    "qipao on every Chinese person), or tourist-cliché props (such as fan, "
    "panda, sushi, tequila bottle, etc.) as the nationality cue. "
    "PERMITTED: contemporary cultural styling — modern casual fashion "
    "typical of the country today, subtle accent colors inspired by the "
    "flag palette in a single small element (a scarf, shoe stripe, button, "
    "etc.), and naturally diverse skin tone / hair common in the country's "
    "population. Cultural styling is encoded per-country in PERSON_NATIONALITY_HINTS "
    "(scripts/build_prompts.py) and injected via {CULTURAL_STYLING_HINT}.",
  ],

  "subject_block_pattern":
    # v3.7: {CULTURAL_STYLING_HINT} 新設・M-47 multicultural variation parity 適用・旗 5-6%。
    "A generic adult person wearing {CULTURAL_STYLING_HINT}, with a neutral "
    "and welcoming expression, standing relaxed. The character's appearance "
    "varies naturally — naturally diverse skin tone (multicultural variation) "
    "and naturally varied hair color and style appropriate to a contemporary "
    "adult population. A small {FLAG_SHAPE_AND_COLORS} national-flag pin or "
    "cloth patch (about 5-6% of the frame) is on the chest or bag strap as "
    "a subtle nationality cue. The person is the clear main subject. "
  ...
  "cultural_styling_hint_definition":
    # v3.7 新規。
    "{CULTURAL_STYLING_HINT} = a short description of CONTEMPORARY fashion "
    "or casual styling typical of the country today, NOT traditional "
    "folkloric / national costume / tourist cliché. Examples per country are "
    "defined in scripts/build_prompts.py PERSON_NATIONALITY_HINTS. The hint "
    "should describe modern everyday casual wear, optionally with subtle "
    "accent colors from the flag palette in a single small element. "
    "Each hint must be neutral and respectful, drawn from contemporary "
    "mainstream fashion conventions in that country.",
